...
// Parallel Fan-Out - steps with shared dependency execute concurrently.
// After the design step completes, three independent implementation
...
func main() {
	wf, err := zenflow.LoadWorkflow("spec/v1/examples/parallel-fan-out.yaml")
	if err != nil {
		log.Fatal("load: ", err)
	}
