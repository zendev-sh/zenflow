...
// Research Team - researcher completes first, then writer,
// fact-checker, and illustrator work in parallel. The coordinator
...
func main() {
	wf, err := zenflow.LoadWorkflow("spec/v1/examples/research-team.yaml")
	if err != nil {
		log.Fatal("load: ", err)
	}
